  ...
  return (
    <div className="mx-auto w-full max-w-[480px] space-y-5">
      <div className="text-center">
        ...
        <h1 className="mt-4 text-[26px] font-semibold tracking-tight text-gray-900">
          Clocked out
        </h1>
        <p className="mt-1 text-[14px] text-gray-500">Thanks {cleanerName.split(' ')[0]} — here's your shift.</p>
      </div>

      {isLoading ? (
        <div className="rounded-3xl bg-white p-6 text-center text-[13px] text-gray-400 ring-1 ring-black/[0.04]">
          Loading your shift…
        </div>
      ) : !summary ? (
        <div className="rounded-3xl bg-white p-6 text-center text-[13px] text-gray-500 ring-1 ring-black/[0.04]">
          You're clocked out. We couldn't pull up the summary just now, but your shift has been saved.
        </div>
      ) : (
        <div className="rounded-3xl bg-white p-6 ring-1 ring-black/[0.04] shadow-[0_1px_2px_rgba(0,0,0,0.04),0_12px_32px_-20px_rgba(0,0,0,0.15)]">
          <div className="text-[11px] font-semibold uppercase tracking-[0.1em] text-gray-400">
            Hours worked
          </div>
          <div className="mt-1 text-[38px] font-semibold leading-none tracking-tight tabular-nums text-gray-900">
          ...
          <div className="mt-5 grid grid-cols-3 gap-3 border-t border-gray-100 pt-5">
            {[
              ...
              <div key={stat.label}>
                <div className="text-[24px] font-semibold leading-none tabular-nums text-gray-900">
                  {stat.value}
                </div>
      ...
      {flagged ? (
        ...
        <div className="space-y-3 rounded-2xl bg-white p-4 ring-1 ring-black/[0.04]">
          <label htmlFor="flag-reason" className="block text-[13.5px] font-semibold text-gray-900">
          ...
          <Textarea
            ...
            className="min-h-[88px] rounded-2xl text-[14px]"
          />
          ...
          <div className="flex gap-2">
            <Button
              ...
              className="h-11 flex-1 rounded-full bg-[#00339B] text-[14px] font-semibold text-white hover:bg-[#002a80]"
            >
              Send to my manager
            </Button>
            <Button
              ...
              className="h-11 rounded-full text-[14px] text-gray-500"
            >
              Cancel
            </Button>
          </div>
        ...
        <Button
          ...
          className="h-11 w-full rounded-full border-gray-200 text-[13.5px] font-medium text-gray-600"
        >
      ...
      <Button
        onClick={onDone}
        className="h-12 w-full rounded-full bg-gray-900 text-[15px] font-semibold text-white hover:bg-gray-800"
      >
        Done
      </Button>
    </div>
